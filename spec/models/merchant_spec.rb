...
RSpec.describe Merchant, type: :model do
  ...
  describe 'class methods' do
    ...
    describe '.total_revenue_generated_by_merchant' do
      it 'returns the total revenue generated by a merchant' do
        ...
        expect(Merchant.total_revenue_generated_by_merchant(merchant01)).to eq(0)
        expect(Merchant.total_revenue_generated_by_merchant(merchant02)).to eq(140)
        expect(Merchant.total_revenue_generated_by_merchant(merchant03)).to eq(110)
        expect(Merchant.total_revenue_generated_by_merchant(merchant04)).to eq(130)
        expect(Merchant.total_revenue_generated_by_merchant(merchant05)).to eq(150)
        expect(Merchant.total_revenue_generated_by_merchant(merchant06)).to eq(160)
      end
    end
  ...
  describe '#total_revenue' do
    it 'returns the total revenue generated by a merchant' do
      ...
      expect(merchant01.total_revenue).to eq(0)
      expect(merchant02.total_revenue).to eq(140)
      expect(merchant03.total_revenue).to eq(110)
      expect(merchant04.total_revenue).to eq(130)
      expect(merchant05.total_revenue).to eq(150)
      expect(merchant06.total_revenue).to eq(160)
    end
  end
end
